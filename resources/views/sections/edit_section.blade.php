        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> 
                    <a href="{{ route('sections') }}">الأعدادات</a> 
                </h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل قسم</span>
            </div>
        </div>
    </div>
    <x-flash-message/>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('section.update',$section->id) }}" method="POST" autocomplete="off">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-info" data-dismiss="modal"> <a  href="{{ route('sections') }}"></a>رجوع</button>
                    </div>
                </form>
            </div>
    </div>
