		...
		<ul class="side-menu">
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">الفواتير المدفوعة جزئياً</a></li>
					<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">الفواتير غير المدفوعة</a></li>
				</ul>
			</li>
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ url('/' . $page='mail') }}">كشف المستخدمين</a></li>
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('sections') }}">إضافة قسم</a></li>
